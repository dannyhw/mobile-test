...
| Tool                 | Test runner / authoring model                          | TypeScript-first authoring | Uses native platform tooling | Custom build required | Built-in screenshot comparison | Broad interaction API | Notes                                                                                      |
| -------------------- | ------------------------------------------------------ | -------------------------- | ---------------------------- | --------------------- | ------------------------------ | --------------------- | ------------------------------------------------------------------------------------------ |
